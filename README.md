...
- `flat/stylistic`: same as `stylistic` but fo ESLint v9 Flat Config.
- `flat/correctness`: same as `correctness` but fo ESLint v9 Flat Config.
- `flat/recommended`: same as `recommended` but fo ESLint v9 Flat Config.
