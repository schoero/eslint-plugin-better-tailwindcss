...
import { ATTRIBUTES_OPTIONS_SCHEMA } from "better-tailwindcss:options/schemas/attributes.js";
...
import { VARIABLES_OPTIONS_SCHEMA } from "better-tailwindcss:options/schemas/variables.js";
...
export const COMMON_OPTIONS = object({
  ...
  ...ATTRIBUTES_OPTIONS_SCHEMA.entries,
  ...VARIABLES_OPTIONS_SCHEMA.entries,
