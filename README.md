...
If an utility is not supported by default, or you want to customize the configuration, you can define which [`attributes`, `callees`, `variables` and `tags`](./docs/settings/settings.md#selectors) should get linted.  
